...
<footer>
    ...
    <div class="mid">
        <p>One Last Beer !! I Promise</p>
        <ul class="socials">
            <li>
                <a target="_blank" href="https://www.facebook.com/aayush.prajapati.90"><i
                        class="ri-facebook-box-line"></i></a>
            </li>
            <li>
                <a target="_blank" href="https://www.instagram.com/aaush__p/"><i class="ri-instagram-line"></i></a>
            </li>
            <li>
                <a target="_blank" href="https://www.linkedin.com/in/aayush-prajapati-3068232b6/"><i
                        class="ri-linkedin-box-fill"></i></a>
            </li>
            <li>
                <a target="_blank" href="https://github.com/Aayush0430"><i class="ri-github-fill"></i></a>
            </li>
            <li>
                <a target="_blank" href="mailto:aayush.prajapati0430@gmail.com"><i class="ri-mail-line"></i></a>
            </li>
        </ul>
    </div>
    <div class="bottom">
