...
function order_mail($conn,$checkout_id,$email){
    ...
    <div class='success-main'>
        <img src='https://lh3.googleusercontent.com/a/ACg8ocKNe8n_mWHnYqEmRk9ZKo28UuY2LqGMc1nJzKLigOwPjGskQwk=s96-c-rg-br100' alt='LOGO' style='height:80px;'>
        <h1>Order Received</h1>
        </div>
        <h4 style='margin-left:20px;'> Thank you for placing an order with Braverage.</h4>
